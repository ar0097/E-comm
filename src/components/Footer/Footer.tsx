      ...
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
        ...
        <div className="flex justify-center">
          ...
          <a
            ...
            href="https://www.instagram.com/arbaz5195/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            className="mr-6 text-neutral-600 dark:text-neutral-200"
            href="https://www.linkedin.com/in/arbaz-shah/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Shirts</a>
            </p>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">T-Shirts</a>
            </p>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Jeans</a>
            </p>
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">Trousers</a>
            </p>
          </div>
